...
class $WalletsTable extends Wallets
  ...
  late final GeneratedColumn<String> colour = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string,
      requiredDuringInsert: false);
  static const VerificationMeta _accentImageFileNameMeta =
      const VerificationMeta('accentImageFileName');
  @override
  late final GeneratedColumn<String> accentImageFileName =
      GeneratedColumn<String>('accent_image_file_name', aliasedName, true,
          additionalChecks: GeneratedColumn.checkTextLength(),
          type: DriftSqlType.string,
          requiredDuringInsert: false);
  ...
  VerificationContext validateIntegrity(Insertable<TransactionWallet> instance,
    ...
    if (data.containsKey('accent_image_file_name')) {
      context.handle(
          _accentImageFileNameMeta,
          accentImageFileName.isAcceptableOrUnknown(
              data['accent_image_file_name']!, _accentImageFileNameMeta));
    }
  ...
  TransactionWallet map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TransactionWallet(
      ...
      accentImageFileName: attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}accent_image_file_name']),
...
class TransactionWallet extends DataClass
  ...
  final String name;
  final String? colour;
  final String? accentImageFileName;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || accentImageFileName != null) {
      map['accent_image_file_name'] = Variable<String>(accentImageFileName);
    }
  ...
  WalletsCompanion toCompanion(bool nullToAbsent) {
    return WalletsCompanion(
      ...
      accentImageFileName: accentImageFileName == null && nullToAbsent
          ? const Value.absent()
          : Value(accentImageFileName),
  ...
  factory TransactionWallet.fromJson(Map<String, dynamic> json,
    ...
    return TransactionWallet(
      ...
      accentImageFileName:
          serializer.fromJson<String?>(json['accentImageFileName']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'accentImageFileName': serializer.toJson<String?>(accentImageFileName),
  ...
  TransactionWallet copyWith(
          ...
          Value<String?> accentImageFileName = const Value.absent(),
      ...
      TransactionWallet(
        ...
        accentImageFileName: accentImageFileName.present
            ? accentImageFileName.value
            : this.accentImageFileName,
  ...
  TransactionWallet copyWithCompanion(WalletsCompanion data) {
    return TransactionWallet(
      ...
      accentImageFileName: data.accentImageFileName.present
          ? data.accentImageFileName.value
          : this.accentImageFileName,
  ...
  String toString() {
    return (StringBuffer('TransactionWallet(')
          ...
          ..write('name: $name, ')
          ..write('colour: $colour, ')
          ..write('accentImageFileName: $accentImageFileName, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is TransactionWallet &&
          ...
          other.accentImageFileName == this.accentImageFileName &&
...
class WalletsCompanion extends UpdateCompanion<TransactionWallet> {
  ...
  final Value<String?> accentImageFileName;
  ...
  const WalletsCompanion({
    ...
    this.accentImageFileName = const Value.absent(),
  ...
  static Insertable<TransactionWallet> custom({
    ...
    Expression<String>? accentImageFileName,
    ...
    return RawValuesInsertable({
      ...
      if (accentImageFileName != null)
        'accent_image_file_name': accentImageFileName,
  ...
  WalletsCompanion copyWith(
      ...
      Value<String>? name,
      Value<String?>? colour,
      Value<String?>? accentImageFileName,
    ...
    return WalletsCompanion(
      ...
      accentImageFileName: accentImageFileName ?? this.accentImageFileName,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (accentImageFileName.present) {
      map['accent_image_file_name'] =
          Variable<String>(accentImageFileName.value);
    }
    if (iconName.present) {
...
class $$WalletsTableFilterComposer
  ...
  ColumnFilters<String> get accentImageFileName => $composableBuilder(
      column: $table.accentImageFileName,
...
class $$WalletsTableOrderingComposer
  ...
  ColumnOrderings<String> get accentImageFileName => $composableBuilder(
      column: $table.accentImageFileName,
...
class $$WalletsTableAnnotationComposer
  ...
  GeneratedColumn<String> get accentImageFileName => $composableBuilder(
      column: $table.accentImageFileName, builder: (column) => column);
  ...
  $$WalletsTableTableManager(_$FinanceDatabase db, $WalletsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            name: name,
            colour: colour,
            accentImageFileName: accentImageFileName,
            iconName: iconName,
...
final class $$ObjectivesTableReferences
  ...
  $$WalletsTableProcessedTableManager? get walletFk {
    if ($_item.walletFk == null) return null;
...
final class $$TransactionsTableReferences
  ...
  $$CategoriesTableProcessedTableManager? get categoryFk {
    if ($_item.categoryFk == null) return null;
    final manager = $$CategoriesTableTableManager($_db, $_db.categories)
...
final class $$CategoryBudgetLimitsTableReferences extends BaseReferences<
  ...
  $$BudgetsTableProcessedTableManager? get budgetFk {
    if ($_item.budgetFk == null) return null;
    final manager = $$BudgetsTableTableManager($_db, $_db.budgets)
...
final class $$ScannerTemplatesTableReferences extends BaseReferences<
  ...
  $$CategoriesTableProcessedTableManager? get defaultCategoryFk {
    if ($_item.defaultCategoryFk == null) return null;
    final manager = $$CategoriesTableTableManager($_db, $_db.categories)
