  ...
  return brightness == Brightness.light
      ? AppColors(
          colors: {
            "white": Colors.white,
            "black": Colors.black,
            "textLight": appStateSettings["increaseTextContrast"] != null
                ? Colors.black.withOpacity(0.7)
                : appStateSettings["materialYou"] != null
                    ? Colors.black.withOpacity(0.4)
                    : Color(0xFF888888),
            "lightDarkAccent": appStateSettings["materialYou"] != null
            ...
            "dividerColor": appStateSettings["materialYou"] != null
                ? Color(0x0F000000)
                : Color(0xFFF0F0F0),
      ...
      : AppColors(
          colors: {
            ...
            "shadowColorLight": appStateSettings["materialYou"] != null
                ? Colors.transparent
                : Color(0x28747474),
...
ColorScheme getGrayScaleColorScheme(Brightness brightness) {
  if (brightness == Brightness.light) {
    return ColorScheme(
      ...
      background:
          appStateSettings["materialYou"] != null ? Colors.blueGrey[50]! : Colors.white,
